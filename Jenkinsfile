pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = 'cithit/shwanaf'                                                                    //<------your MiamiID
        IMAGE_TAG = "build-${BUILD_NUMBER}"
        GITHUB_URL = 'https://github.com/Farha-Shwana/225-Lab3-7.git'                                    //<------your MiamiID
        KUBECONFIG = credentials('shwanaf-225-sp26')                                                         //<------your MiamiID
    }
        ...
        stage ("Run Security Checks") {
            steps {
                ...
                sh '''
                    ...
                    -e BURP_START_URL=http://10.48.229.165 \
